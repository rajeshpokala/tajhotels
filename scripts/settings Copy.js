...
function initSdk(name) {
    ...
    const chatWidgetSettings = {
        URI: 'oda-e3d3f946cc4749c7b1bef4ea68f1b89c-da3.data.digitalassistant.oci.oraclecloud.com',                               // ODA URI, only the hostname part should be passed, without the https://
        ...
        channelId: '8e4f3cb6-1026-4678-bb75-cde3a08ead5d',                   // Channel ID, available in channel settings in ODA UI, optional if client auth enabled
        ...
        i18n: {                                     // Provide translations for the strings used in the widget
            en: {                                   // en locale, can be configured for any locale
                chatTitle: 'ZOYA'       // Set title at chat header
            }
        },
